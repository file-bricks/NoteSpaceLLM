...
const UI_TEXT = Object.freeze({
  de: Object.freeze({
    ...
    cacheHintEmpty: "Kein Workspace dauerhaft gespeichert.",
    cacheHintWithTitle: (title) => `Aktueller Workspace: ${title}.`,
    offlineStateOnline: "Aktuell online; importierte Workspace-Inhalte bleiben nur in dieser Sitzung.",
    offlineStateOffline: "Aktuell offline; importieren Sie eine Workspace-Datei erneut, falls die Sitzung leer ist.",
    ...
    cacheCleared: "Lokale Workspace-Reste gelöscht. Die aktuelle Ansicht bleibt bis zum Neuladen sichtbar.",
  ...
  en: Object.freeze({
    ...
    cacheHintEmpty: "No workspace is stored persistently.",
    cacheHintWithTitle: (title) => `Current workspace: ${title}.`,
    offlineStateOnline: "Currently online; imported workspace content stays in this session only.",
    offlineStateOffline: "Currently offline; re-import a workspace file if this session is empty.",
    ...
    cacheCleared: "Local workspace leftovers cleared. The current view remains visible until reloading.",
  ...
  es: Object.freeze({
    ...
    cacheHintEmpty: "No hay ningún workspace guardado de forma persistente.",
    cacheHintWithTitle: (title) => `Workspace actual: ${title}.`,
    offlineStateOnline: "Actualmente en línea; el contenido importado permanece solo en esta sesión.",
    offlineStateOffline: "Actualmente sin conexión; vuelve a importar un workspace si esta sesión está vacía.",
    ...
    cacheCleared: "Restos locales del workspace borrados. La vista actual permanece visible hasta recargar.",
  ...
  "zh-Hans": Object.freeze({
    ...
    exportNotes: "导出评审笔记",
    clearNotes: "清空笔记",
    cacheHintEmpty: "没有持久保存的工作区。",
    cacheHintWithTitle: (title) => `当前工作区：${title}。`,
    offlineStateOnline: "当前在线；导入的工作区内容仅保留在本次会话中。",
    offlineStateOffline: "当前离线；如果本次会话为空，请重新导入工作区文件。",
    ...
    cacheCleared: "本地工作区残留已清除。当前视图会保留到重新加载为止。",
    reviewFilenameSuffix: "review-notes",
  ...
  ja: Object.freeze({
    ...
    clearNotes: "ノートを消去",
    cacheHintEmpty: "永続保存されたワークスペースはありません。",
    cacheHintWithTitle: (title) => `現在のワークスペース：${title}。`,
    offlineStateOnline: "現在オンラインです。インポートしたワークスペース内容はこのセッション内にのみ保持されます。",
    offlineStateOffline: "現在オフラインです。このセッションが空の場合はワークスペースファイルを再インポートしてください。",
    ...
    cacheCleared: "ローカルワークスペースの残存データを削除しました。現在の表示は再読み込みまで残ります。",
    reviewFilenameSuffix: "review-notes",
  ...
  ru: Object.freeze({
    ...
    cacheHintEmpty: "Workspace не сохраняется постоянно.",
    cacheHintWithTitle: (title) => `Текущий workspace: ${title}.`,
    offlineStateOnline: "Сейчас онлайн; импортированное содержимое workspace хранится только в этой сессии.",
    offlineStateOffline: "Сейчас офлайн; импортируйте файл workspace заново, если эта сессия пуста.",
    ...
    cacheCleared: "Локальные остатки workspace очищены. Текущий вид останется до перезагрузки.",
    reviewFilenameSuffix: "review-notes",
